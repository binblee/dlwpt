...
def findPositiveSamples(data_path, start_ndx=0, limit=100):
    ds = LunaDataset(data_path=data_path)
    positiveSample_list = []
...
def showCandidate(data_path, series_uid, batch_ndx=None, **kwargs) -> None:
    ds = LunaDataset(data_path=data_path, series_uid=series_uid, **kwargs)
